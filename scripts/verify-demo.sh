...
curl -s "$BASE_URL/client/compliance-review-package/validation" | python3 -m json.tool | sed -n '1,80p'
...
curl -s "$BASE_URL/client/procurement-review-package/validation" | python3 -m json.tool | sed -n '1,80p'
...
curl -s "$BASE_URL/client/pilot-sow-package/validation" | python3 -m json.tool | sed -n '1,80p'

echo
echo "---- client pilot kickoff package ----"
curl -s "$BASE_URL/client/pilot-kickoff-package" | python3 -m json.tool | sed -n '1,100p'

echo
echo "---- client pilot kickoff package validation ----"
curl -s "$BASE_URL/client/pilot-kickoff-package/validation" | python3 -m json.tool | sed -n '1,80p'

echo
echo "---- client pilot decision packet ----"
curl -s "$BASE_URL/client/pilot-decision-packet" | python3 -m json.tool | sed -n '1,100p'

echo
echo "---- client pilot decision packet validation ----"
curl -s "$BASE_URL/client/pilot-decision-packet/validation" | python3 -m json.tool | sed -n '1,80p'
...
curl -s "$BASE_URL/client/control-matrix/validation" | python3 -m json.tool | sed -n '1,80p'
...
curl -s "$BASE_URL/client/acceptance-gate/validation" | python3 -m json.tool | sed -n '1,80p'
...
curl -s "$BASE_URL/client/adapter-registry/validation" | python3 -m json.tool | sed -n '1,80p'
...
curl -s "$BASE_URL/client/work-order/validation" | python3 -m json.tool | sed -n '1,80p'
